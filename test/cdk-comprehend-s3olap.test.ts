...
test('IAM role test', () => {
  ...
  expect(SynthUtils.toCloudFormation(stack)).toHaveResource('AWS::S3::AccessPoint', {
    "Name": "accessctl-s3-ap-survey-results-unknown-pii",
    "Bucket": {
      "Ref": "ComprehendS3olabSurveyResultBucketAED4B852"
    }
  });
  ...
  expect(SynthUtils.toCloudFormation(stack)).toHaveResource('AWS::S3ObjectLambda::AccessPoint', {
      ...
      "SupportingAccessPoint": {
        "Fn::Join": [
          ...
          [
            ...
            ":accesspoint/accessctl-s3-ap-survey-results-unknown-pii"
          ]
        ]
      },
